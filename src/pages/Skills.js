      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-around offset-1 skills-wrapper">
          ...
          <div className="skills-icon" data-aos="zoom-in-right">
            <img
              className="img-fluid icons"
              src={require("../img/java-script.png")}
              alt="javascript icon"
            />
          </div>
          <div className="skills-icon" data-aos="zoom-in-right">
        ...
        <div className="row tools-wrapper">
          ...
          <div className="col">
            <div className="tools-desc">
              <p>
                MS Word, PPT, Excel, VSCODE, Eclipse, Intellij, Figma, Canva,
                Adobe Photoshop, Adobe Illustrator, Adobe XD, Adobe Indesign,
                Adobe Creative Suite, Canva, Contentful, Jira.
              </p>
            </div>
          </div>
        </div>

        <div className="row other-tools">
          <div className="col-sm-2 offset-sm-1">
            <div>
              <h6 className="skills-title">Design Portfolio</h6>
            </div>
          </div>
          ...
          <div className="col">
            <div className="tools-desc">
              <p>
                <a href="https://dribbble.com/joycepestin" target="_blank">
                  Dribble
                </a>
              </p>
            </div>
